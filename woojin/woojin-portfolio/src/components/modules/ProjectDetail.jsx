...
function ProjectDetail(props) {
  useEffect(() => {
    $(document).mouseup(function (e) {
      ...
      let isDisplay = $(".Scp-detail").css("display") != "none";
          ...
          <div className="desc-wrap">
            ...
            <div className="detail-wrap">
              <div className="col-7 dt-img">
                <ul>
                  <li>
                    <img
                      src="/images/plants/product_list.png"
                      alt="product_list"
                    />
                  </li>
                  <li>
                    <img
                      src="/images/plants/product_detail.png"
                      alt="product_detail"
                    />
                  </li>
                  <li>
                    <img
                      src="/images/plants/product_swiper.png"
                      alt="product_swiper"
                    />
                  </li>
                </ul>
              ...
              <div className="col-5 dt-desc">
                ...
                <ul>
                  ...
                  <li>
                    해당 상품 클릭 시 키값을 갖고 상세 페이지로 이동 후 해당
                    데이터 출력
                  </li>
                  <li>마우스 오버 시 이미지 변경 및 하단 장바구니 버튼 등장</li>
                  <li>상품 수량 카운트 및 장바구니 기능</li>
                  <li>상세 페이지에서 이미지 클릭 시 스와이퍼 슬라이드 등장</li>
                </ul>
              </div>
            </div>
            <div className="detail-wrap">
            ...
            <div className="detail-wrap">
              <div className="col-7 dt-img">
                <ul>
                  ...
                  <li>
                    <img
                      src="/images/plants/search_page.png"
                      alt="search_page"
                    />
                  </li>
                </ul>
            ...
            <div className="detail-wrap">
              <div className="col-7 dt-img">
                <ul>
                  ...
                  <li>
                    <img
                      src="/images/plants/board_detail.png"
                      alt="board_detail"
                    />
                  </li>
                </ul>
            ...
            <div className="detail-wrap">
              ...
              <div className="col-5 dt-desc">
                <p>마이 페이지</p>
                <ul>
                  <li>내 정보, 내 게시글, 내 장바구니, 로그아웃 구현</li>
            ...
            <div className="detail-wrap">
              <div className="dt-desc">
                ...
                <ul className="etc-list">
                  <li>텍스트 배너 무한 슬라이드</li>
                  <li>메인 페이지 스크롤 페이드 인아웃 기능</li>
                  <li>
                    미디어쿼리 - 상품 리스트 스와이퍼로 변환 / 네비바 햄버거
                    노출 / 레이아웃 변경
                  </li>
                  <li>FaQ 토글 기능</li>
